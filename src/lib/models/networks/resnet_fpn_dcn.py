...
class PoseResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(ret['hm'].shape, ret['wh'].shape, ret['id'].shape, ret['reg'].shape)
        # torch.Size([11, 1, 120, 160]) torch.Size([11, 4, 120, 160]) torch.Size([11, 128, 120, 160]) torch.Size([11, 2, 120, 160])
        return [ret]
